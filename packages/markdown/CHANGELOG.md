...
- a24c64f: fix(markdown): tag prose/code nested in quote/list containers for projection negotiation
...
- 00e9556: feat(markdown): generic imageResolver -> ImageSource, CapGlyph stays app-layer adapter
...
- e7b57e1: Add `MarkdownOptions.tableViewportHeight`, so a Markdown table can use
...
- 032728b: Add per-kind affordance config and an optional code-block border color:
