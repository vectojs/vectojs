...
Applications that only need the native text field or text-measurement helpers can use lightweight
subpaths. They exclude content-rendering dependencies such as Markdown and MathJax from the
application bundle:
