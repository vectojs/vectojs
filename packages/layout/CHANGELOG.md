...
- 391cd55: Four P2 fixes from the 2026-08-13 review:
...
- 4c83ccb: Add `InlineObject.key`, so an object span's memo cannot serve the wrong painter.
...
- ae6d6ad: Add `TextStyle.lineThrough` so a text run can be struck through.
