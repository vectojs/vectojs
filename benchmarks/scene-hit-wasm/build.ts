// G3 integrated browser confirmation: bundle entry.ts (full @vectojs/core
// resolved to workspace SOURCE, so it reflects the current G3 Scene.findEntityAt
// integration) and inline it into page/index.html; copy the built wasm into
// page/. Run before ../run-browsers.sh scene-hit-wasm <port>.
//   bun run benchmarks/scene-hit-wasm/build.ts
...
<html>
  <head>
    <meta charset="utf-8" />
    <title>vectojs scene-hit-wasm bench</title>
  </head>
  <body>
