...
// page/index.html. Run before ../run-browsers.sh content-projection <port>.
//   bun run benchmarks/content-projection/build.ts
...
<html>
  <head>
    <meta charset="utf-8" />
    <title>vectojs content-projection gate bench</title>
  </head>
  <body>
