...
// the current VirtualList Fenwick + RichText memo) and inline it into
// page/index.html. Run before ../run-browsers.sh ui-perf <port>.
//   bun run benchmarks/ui-perf/build.ts
...
<html>
  <head>
    <meta charset="utf-8" />
    <title>vectojs ui-perf bench</title>
  </head>
  <body>
