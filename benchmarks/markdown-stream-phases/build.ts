...
// page/index.html. Run before ../run-browsers.sh markdown-stream-phases <port>.
//   bun run benchmarks/markdown-stream-phases/build.ts
...
<html>
  <head>
    <meta charset="utf-8" />
    <title>vectojs markdown-stream-phases gate bench</title>
  </head>
  <body>
