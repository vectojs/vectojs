...
// page/index.html. Run before ../run-browsers.sh render-canvas-libs <port>.
//   bun run benchmarks/render-canvas-libs/build.ts
...
<html>
  <head>
    <meta charset="utf-8" />
    <title>vectojs render-canvas-libs gate bench</title>
  </head>
  <body>
