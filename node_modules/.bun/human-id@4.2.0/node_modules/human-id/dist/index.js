...
export const adverbs = ["bravely", "brightly", "busily", "daily", "freely", "hungrily", "joyously", "knowingly", "lazily", "noisily", "oddly", "politely", "quickly", "quietly", "rapidly", "safely", "sleepily", "slowly", "truly", "yearly"];
function random(arr) { return arr[Math.floor(Math.random() * arr.length)]; }
function longest(arr) { return arr.reduce((a, b) => a.length > b.length ? a : b); }
function shortest(arr) { return arr.reduce((a, b) => a.length < b.length ? a : b); }
/**
 * Returns the human-id
 */
export function humanId(options = {}) {
